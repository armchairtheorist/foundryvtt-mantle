...
const MASTERIES = {
  general: [
    ["Athlete", "body", 1, "When climbing or swimming, you can Move and Shift as per normal, but every square while climbing or swimming is treated as difficult terrain. When doing a horizontal jump, you can traverse obstacles up to a length of half your SPD. When doing a vertical jump, you can jump a number of squares equal to twice your SIZE."],
    ["Creativity", "mind", 1, "Increase your cap for Assists and Push Yourself during narrative play from +2d to +3d."],
    ["Storied Past", "soul", 1, "Dedication Gain one additional Thread."],
    ["Abundance", "body", 1, "+1 Wondrous Item slot.", { sets: [S.benkei] }],
    ["Alacrity", "body", 1, "+1 SPD.", { sets: [S.shukuchi] }],
    ["Cauterize", "soul", 1, "Gain the Cauterize maneuver (Vigor 2): Spend 1 Resolve and remove one Wound. You gain Wracked 3 (Fire)."],
    ["Composure", "mind", 1, "+2 Resolve."],
    ["Fireman", "body", 1, "Gain Resistance (Fire).", { resistances: ["fire"] }],
    ["Fleeting Spirit", "soul", 1, "If you are the first combatant to act in a round (before any allies or adversaries), you gain +2d to the first attack you make on your turn.", { sets: [S.shukuchi] }],
    ["Fortune's Blessing", "soul", 2, "Prerequisite: LUCK 2 Instead of spending Momentum, you can choose to spend 1 Resolve to activate a Momentous Fortune for yourself.", { prereq: "LUCK 1", sets: [S.overflowingFortune] }],
    ["Fortune's Escape", "soul", 1, "Prerequisite: Fortune's Blessing When you activate a Momentous Fortune for yourself, you can choose to reroll twice, and choose the better result between the three rolls.", { prereq: "Fortune's Blessing", sets: [S.overflowingFortune] }],
    ...
    ["Shared Fortune", "soul", 1, "Prerequisite: Fortune's Blessing Instead of spending Momentum, you can choose to spend 1 Resolve on behalf of an ally to activate a Momentous Fortune for them.", { prereq: "Fortune's Blessing", sets: [S.overflowingFortune] }],
    ["Vigorous", "body", 1, "+1 Vigor refresh.", { bonuses: { vigorRefresh: 1 } }],
    ["Willpower", "mind", 1, "+1d when opposing rolls with INS."]
  ],

  martial: [
    ["Bloodlust", "body", 1, "Your Slashing or Piercing melee weapon attacks gain the pattern: Bloodlust (Triple N): Target gains Wracked 1 (Bleeding).", { sets: [S.bloodbath] }],
    ...
    ["Pulverize", "body", 1, "Your Crushing melee weapon attacks gain the pattern: Pulverize (Triple N): Target gains Hindered."],
    ["Quartermaster", "body", 1, "+1 gear slot.", { sets: [S.benkei] }]
  ],

  warrior: [
    ["Delaying Strike", "mind", 1, "Your Focused Strike attacks gain the pattern: Delaying Strike (Triple N): The target gains the Slowed condition."],
    ["On Guard", "mind", 1, "Gain the On Guard maneuver (Vigor 1): Restore Guard back to full."],
    ["Resolute Strike", "soul", 1, "Your Focused Strike attacks gain the pattern: Resolute Strike (Double N): Spend 1 Resolve to add +8 damage."],
    ["The Best Offense is a Good Defense", "body", 1, "Your Focused Strike attacks gain the patterns: The Best Offense is a Good Defense (Double N): Add your current Guard value (including any Over-Guard) to your damage; your Guard becomes 0. The Best Offense is a Good Defense (Triple N): Add twice your current Guard value (including any Over-Guard) to your damage; your Guard becomes 0."],
    ...
    ["Missile Parry", "body", 2, "You may Deflect ranged attacks, in addition to melee attacks. The weight class rule still applies (your Deflecting weapon's weight class must equal or exceed the attacker's); Shield-tagged weapons remain exempt from the weight class rule."],
    ...
    ["Steady Stance", "body", 1, "At the end of your turn, if you did not use the Move maneuver this turn, gain +1 Guard. This can result in Over-Guard."],
  ...
  barbarian: [
    ["Battle Trance", "soul", 1, "While Frenzied, when you would take a Wound, you may take a Burden instead."],
    ...
    ["Bloody Armor", "soul", 1, "At the start of your turn, gain an extra +1 Guard for every stack of Wracked (Bleeding) on yourself, after your Guard refreshes. This can result in Over-Guard.", { sets: [S.bloodbath] }],
  ...
  channeler: [
    ...
    ["Patron's Mark", "mind", 1, "When you cast a spell on a creature, it gains your Patron's Mark (only one creature carries the Mark at a time; casting on a different creature moves it). When you cast a spell on the Marked creature: the spellcasting roll gains +1d. The Mark is then consumed."],
    ["Mending Spirit", "mind", 1, "When you cast Mend, both you (the caster) and the target gain +5 Guard, regardless of the band rolled or which effect ladder the Mend uses. This can result in Over-Guard."],
    ["Smite of the Patron", "soul", 1, "Your Rend attacks gain the pattern: Smite of the Patron (Double N): Spend 1 Resolve to add +8 damage (Vitality-ladder Rend) or +3 Strain (Strain-ladder Rend)."]
  ],
  ...
  human: [
    ...
    ["Iron Will", "soul", 1, "+2 Max Strain. Gain the Iron Will reaction (Vigor 1): Trigger: When you are about to take Strain from an incoming attack. Effect: Halve the Strain that you take.", { bonuses: { strain: 2 } }],
  ...
  elf: [
    ["Blade Dancer", "body", 1, "When a melee attack hits you (at any band, including a graze), you may immediately move 1 square in any direction at no Vigor cost. This movement resolves after the attack's damage but before any other post-attack effects. This movement doesn't trigger any Intercept or Forestall attacks."],
    ["Eldritch Sense", "mind", 1, "Gain the Detect Magic maneuver (see the Scholar archetype's Rank 2 entry)."],
    ["Elven Accuracy", "mind", 2, "+1d on ranged attacks that are not Indefensible, Imprecise, or Seeking — including spell attacks that qualify (e.g., Terra Rend at range). Does not apply to melee attacks."],
    ...
    ["Inner Focus", "soul", 1, "Your own soul serves as a spellcasting focus: you never take the -1d no-focus penalty for casting without a spell focus equipped. This functions as a basic focus only — it grants none of an exotic focus's bonuses. Applies to all your casting, innate or path-granted."],
    ["Old Sight", "soul", 1, "You sense magic, Fey, and undead within 5 squares of you. No roll required. For creatures of these types in range: Hidden → Obscured; Obscured → Visible; Visible → unchanged."],
    ["Sylvan Step", "body", 1, "You ignore difficult terrain from natural sources (foliage, undergrowth, snow, sand, vines — GM adjudicates ambiguous cases). +1d on Stealth action rolls in natural environments."],
